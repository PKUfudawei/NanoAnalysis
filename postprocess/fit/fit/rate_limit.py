...
for file in os.listdir('datacard/Run2/'):
        os.system(f"combine -M AsymptoticLimits datacard/Run2/{file} --setParameters pdfindex_Tag0=0 --freezeParameters pdfindex_Tag0 -n f{file.split('.')[0].replace('datacard_', '.')}")
