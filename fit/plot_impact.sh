...
rm -rf *.root
combineTool.py -M Impacts -d datacard/Run2/1000/SRH.root -m 125 --rMin -0.5 --rMax 0.5 --robustFit 1 --doInitialFit --X-rtd REMOVE_CONSTANT_ZERO_POINT=1 --X-rtd MINIMIZER_freezeDisassociatedParams
combineTool.py -M Impacts -d datacard/Run2/1000/SRH.root -m 125 --rMin -0.5 --rMax 0.5 --robustFit 1 --doFits
combineTool.py -M Impacts -d datacard/Run2/1000/SRH.root -m 125 --rMin -0.5 --rMax 0.5 --output impacts/Run2/impacts_Hbb_1000.json
